    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings IN) : SV_Target
            {
                ...
                float3 posOS = TransformWorldToObject(IN.positionWS);
                ...
                half4 finalColor;
                    ...
                    finalColor = half4(col * (fres + texLuma * _TexToEmission), alpha);
                #else
                    finalColor = half4(col + emission, alpha);
                #endif
        ...
        Pass
        {
            ...
            half4 frag (Varyings IN) : SV_Target
            {
                ...
                half4 finalColor = half4(col * (fres + texLuma * _TexToEmission), alpha);
                finalColor.rgb = MixFog(finalColor.rgb, IN.fogFactor);
                return finalColor;
            }
            ENDHLSL
