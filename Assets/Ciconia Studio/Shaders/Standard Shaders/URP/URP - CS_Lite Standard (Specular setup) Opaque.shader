	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g563 = uv_BaseMap;
				...
				float4 tex2DNode7_g562 = tex2D( _BaseMap, ( ( appendResult14_g563 + appendResult13_g563 ) + Parallaxe375 ) );
				float4 lerpResult53_g562 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g562 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g562 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g562 = lerpResult53_g562.rgb;
				float desaturateDot29_g562 = dot( desaturateInitialColor29_g562, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g562 = lerp( desaturateInitialColor29_g562, desaturateDot29_g562.xxx, -clampResult27_g562 );
				float4 temp_output_410_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g562 , 0.0 ));
				float2 uv_DetailAlbedoMap = IN.ase_texcoord8.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float4 tex2DNode7_g609 = tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap );
				float clampResult27_g609 = clamp( _DetailSaturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g609 = ( _DetailColor * tex2DNode7_g609 ).rgb;
				...
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g562.a ) ):( tex2DNode7_g562.a ));
				float4 clampResult38_g551 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),(( _SourceMask )?( ( (( _InvertMask )?( ( 1.0 - tex2DNode27_g551 ) ):( tex2DNode27_g551 )) + BaseColorAlpha46 ) ):( (( _InvertMask )?( ( 1.0 - tex2DNode27_g551 ) ):( tex2DNode27_g551 )) ))) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g551 * _IntensityMask ) ):( temp_cast_6 ));
				float4 lerpResult365 = lerp( temp_output_410_0 , AlbedoDetail153 , Mask158);
				float4 blendOpSrc364 = temp_output_410_0;
				...
				float2 break26_g565 = uv_BumpMap;
				...
				float3 unpack4_g564 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g565 + appendResult13_g565 ) + Parallaxe375 ) ), _BumpScale );
				unpack4_g564.z = lerp( 1, unpack4_g564.z, saturate(_BumpScale) );
				float3 tex2DNode4_g564 = unpack4_g564;
				float3 temp_output_411_0 = tex2DNode4_g564;
				...
				float3 lerpResult137 = lerp( temp_output_411_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_411_0 , BlendNormal( temp_output_411_0 , NormalDetail155 ) , Mask158.rgb);
				...
				float2 break26_g569 = uv_EmissionMap;
				...
				float4 temp_output_5_0_g568 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g569 + appendResult13_g569 ) + Parallaxe375 ) ) );
				float4 Emission110 = ( temp_output_5_0_g568 * _EmissionIntensity );
				...
				float switchResult36_g560 = (((ase_vface>0)?(_Smoothness):(_SmoothnessBack)));
				#if defined(_SOURCE_SPECULARALPHA)
				float staticSwitch31_g560 = ( tex2DNode3_g560.a * switchResult36_g560 );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch31_g560 = ( switchResult36_g560 * BaseColorAlpha46 );
				#else
				float staticSwitch31_g560 = ( tex2DNode3_g560.a * switchResult36_g560 );
				#endif
				float DetailBaseColorAlpha170 = ( _DetailColor.a * tex2DNode7_g609.a );
				...
				float2 break26_g567 = uv_OcclusionMap;
				...
				float blendOpSrc2_g566 = tex2D( _OcclusionMap, ( ( appendResult14_g567 + appendResult13_g567 ) + Parallaxe375 ) ).r;
				float blendOpDest2_g566 = ( 1.0 - _OcclusionStrength );
				float AmbientOcclusion94 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g566 ) * ( 1.0 - blendOpDest2_g566 ) ) ));
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g562.a ) ):( tex2DNode7_g562.a ));
				float4 clampResult38_g551 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),(( _SourceMask )?( ( (( _InvertMask )?( ( 1.0 - tex2DNode27_g551 ) ):( tex2DNode27_g551 )) + BaseColorAlpha46 ) ):( (( _InvertMask )?( ( 1.0 - tex2DNode27_g551 ) ):( tex2DNode27_g551 )) ))) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g551 * _IntensityMask ) ):( temp_cast_2 ));
				float3 lerpResult137 = lerp( temp_output_411_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_411_0 , BlendNormal( temp_output_411_0 , NormalDetail155 ) , Mask158.rgb);
				float3 Normal27 = (( _BlendMainNormal )?( lerpResult205 ):( lerpResult137 ));
