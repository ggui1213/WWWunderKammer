	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g592 = uv_BaseMap;
				...
				float4 tex2DNode7_g591 = tex2D( _BaseMap, ( ( appendResult14_g592 + appendResult13_g592 ) + Parallaxe373 ) );
				float4 lerpResult53_g591 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g591 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g591 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g591 = lerpResult53_g591.rgb;
				float desaturateDot29_g591 = dot( desaturateInitialColor29_g591, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g591 = lerp( desaturateInitialColor29_g591, desaturateDot29_g591.xxx, -clampResult27_g591 );
				float4 temp_output_437_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g591 , 0.0 ));
				...
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g591.a ) ):( tex2DNode7_g591.a ));
				float4 clampResult38_g584 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),(( _SourceMask )?( ( (( _InvertMask )?( ( 1.0 - tex2DNode27_g584 ) ):( tex2DNode27_g584 )) + BaseColorAlpha46 ) ):( (( _InvertMask )?( ( 1.0 - tex2DNode27_g584 ) ):( tex2DNode27_g584 )) ))) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g584 * _IntensityMask ) ):( temp_cast_6 ));
				float4 lerpResult365 = lerp( temp_output_437_0 , AlbedoDetail153 , Mask158);
				float4 blendOpSrc364 = temp_output_437_0;
				...
				float2 break26_g594 = uv_BumpMap;
				...
				float3 unpack4_g593 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g594 + appendResult13_g594 ) + Parallaxe373 ) ), _BumpScale );
				unpack4_g593.z = lerp( 1, unpack4_g593.z, saturate(_BumpScale) );
				float3 tex2DNode4_g593 = unpack4_g593;
				float3 temp_output_438_0 = tex2DNode4_g593;
				...
				float3 lerpResult137 = lerp( temp_output_438_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_438_0 , BlendNormal( temp_output_438_0 , NormalDetail155 ) , Mask158.rgb);
				...
				float2 break26_g600 = uv_EmissionMap;
				float2 appendResult14_g600 = (float2(( break26_g600.x * GlobalTilingX11 ) , ( break26_g600.y * GlobalTilingY8 )));
				float2 appendResult13_g600 = (float2(( break26_g600.x + GlobalOffsetX10 ) , ( break26_g600.y + GlobalOffsetY9 )));
				float4 temp_output_5_0_g599 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g600 + appendResult13_g600 ) + Parallaxe373 ) ) );
				float4 Emission110 = ( temp_output_5_0_g599 * _EmissionIntensity );
				...
				float switchResult34_g589 = (((ase_vface>0)?(_Smoothness):(_SmoothnessBack)));
				#if defined(_SOURCE_METALLICALPHA)
				float staticSwitch23_g589 = ( tex2DNode3_g589.a * switchResult34_g589 );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch23_g589 = ( switchResult34_g589 * BaseColorAlpha46 );
				#else
				float staticSwitch23_g589 = ( tex2DNode3_g589.a * switchResult34_g589 );
				#endif
				...
				float2 break26_g598 = uv_OcclusionMap;
				float2 appendResult14_g598 = (float2(( break26_g598.x * GlobalTilingX11 ) , ( break26_g598.y * GlobalTilingY8 )));
				float2 appendResult13_g598 = (float2(( break26_g598.x + GlobalOffsetX10 ) , ( break26_g598.y + GlobalOffsetY9 )));
				float blendOpSrc2_g597 = tex2D( _OcclusionMap, ( ( appendResult14_g598 + appendResult13_g598 ) + Parallaxe373 ) ).r;
				float blendOpDest2_g597 = ( 1.0 - _OcclusionStrength );
				float AmbientOcclusion94 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g597 ) * ( 1.0 - blendOpDest2_g597 ) ) ));
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g591.a ) ):( tex2DNode7_g591.a ));
				float4 clampResult38_g584 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),(( _SourceMask )?( ( (( _InvertMask )?( ( 1.0 - tex2DNode27_g584 ) ):( tex2DNode27_g584 )) + BaseColorAlpha46 ) ):( (( _InvertMask )?( ( 1.0 - tex2DNode27_g584 ) ):( tex2DNode27_g584 )) ))) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g584 * _IntensityMask ) ):( temp_cast_2 ));
				float3 lerpResult137 = lerp( temp_output_438_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_438_0 , BlendNormal( temp_output_438_0 , NormalDetail155 ) , Mask158.rgb);
				float3 Normal27 = (( _BlendMainNormal )?( lerpResult205 ):( lerpResult137 ));
