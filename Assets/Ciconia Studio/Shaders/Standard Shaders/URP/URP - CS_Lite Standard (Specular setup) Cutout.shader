	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g603 = uv_BaseMap;
				float GlobalTilingX11 = ( _GlobalXYTilingXYZWOffsetXY.x - 1.0 );
				float GlobalTilingY8 = ( _GlobalXYTilingXYZWOffsetXY.y - 1.0 );
				float2 appendResult14_g603 = (float2(( break26_g603.x * GlobalTilingX11 ) , ( break26_g603.y * GlobalTilingY8 )));
				float GlobalOffsetX10 = _GlobalXYTilingXYZWOffsetXY.z;
				float GlobalOffsetY9 = _GlobalXYTilingXYZWOffsetXY.w;
				float2 appendResult13_g603 = (float2(( break26_g603.x + GlobalOffsetX10 ) , ( break26_g603.y + GlobalOffsetY9 )));
				float2 uv_ParallaxMap = IN.ase_texcoord8.xy * _ParallaxMap_ST.xy + _ParallaxMap_ST.zw;
				float2 break26_g596 = uv_ParallaxMap;
				float2 appendResult14_g596 = (float2(( break26_g596.x * GlobalTilingX11 ) , ( break26_g596.y * GlobalTilingY8 )));
				float2 appendResult13_g596 = (float2(( break26_g596.x + GlobalOffsetX10 ) , ( break26_g596.y + GlobalOffsetY9 )));
				float4 temp_cast_0 = (tex2D( _ParallaxMap, ( appendResult14_g596 + appendResult13_g596 ) ).g).xxxx;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 ase_tanViewDir =  tanToWorld0 * WorldViewDirection.x + tanToWorld1 * WorldViewDirection.y  + tanToWorld2 * WorldViewDirection.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 paralaxOffset36_g595 = ParallaxOffset( temp_cast_0.x , _Parallax , ase_tanViewDir );
				float2 switchResult47_g595 = (((ase_vface>0)?(paralaxOffset36_g595):(0.0)));
				float2 Parallaxe380 = switchResult47_g595;
				float4 tex2DNode7_g602 = tex2D( _BaseMap, ( ( appendResult14_g603 + appendResult13_g603 ) + Parallaxe380 ) );
				float4 lerpResult53_g602 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g602 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g602 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g602 = lerpResult53_g602.rgb;
				float desaturateDot29_g602 = dot( desaturateInitialColor29_g602, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g602 = lerp( desaturateInitialColor29_g602, desaturateDot29_g602.xxx, -clampResult27_g602 );
				float4 temp_output_419_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g602 , 0.0 ));
				...
				float4 tex2DNode27_g604 = tex2D( _DetailMask, uv_DetailMask );
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g602.a ) ):( tex2DNode7_g602.a ));
				float4 clampResult38_g604 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),(( _SourceMask )?( ( (( _InvertMask )?( ( 1.0 - tex2DNode27_g604 ) ):( tex2DNode27_g604 )) + BaseColorAlpha46 ) ):( (( _InvertMask )?( ( 1.0 - tex2DNode27_g604 ) ):( tex2DNode27_g604 )) ))) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g604 * _IntensityMask ) ):( temp_cast_6 ));
				...
				float3 tex2DNode4_g588 = unpack4_g588;
				float3 temp_output_420_0 = tex2DNode4_g588;
				float2 uv_DetailNormalMap = IN.ase_texcoord8.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float3 unpack4_g610 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale );
				unpack4_g610.z = lerp( 1, unpack4_g610.z, saturate(_DetailNormalMapScale) );
				float3 NormalDetail155 = unpack4_g610;
				float3 lerpResult137 = lerp( temp_output_420_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_420_0 , BlendNormal( temp_output_420_0 , NormalDetail155 ) , Mask158.rgb);
				...
				float2 break26_g593 = uv_EmissionMap;
				float2 appendResult14_g593 = (float2(( break26_g593.x * GlobalTilingX11 ) , ( break26_g593.y * GlobalTilingY8 )));
				float2 appendResult13_g593 = (float2(( break26_g593.x + GlobalOffsetX10 ) , ( break26_g593.y + GlobalOffsetY9 )));
				float4 temp_output_5_0_g592 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g593 + appendResult13_g593 ) + Parallaxe380 ) ) );
				float4 Emission110 = ( temp_output_5_0_g592 * _EmissionIntensity );
				...
				float switchResult36_g584 = (((ase_vface>0)?(_Smoothness):(_SmoothnessBack)));
				#if defined(_SOURCE_SPECULARALPHA)
				float staticSwitch31_g584 = ( tex2DNode3_g584.a * switchResult36_g584 );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch31_g584 = ( switchResult36_g584 * BaseColorAlpha46 );
				#else
				float staticSwitch31_g584 = ( tex2DNode3_g584.a * switchResult36_g584 );
				#endif
				float DetailBaseColorAlpha170 = ( _DetailColor.a * tex2DNode7_g612.a );
				...
				float2 break26_g591 = uv_OcclusionMap;
				float2 appendResult14_g591 = (float2(( break26_g591.x * GlobalTilingX11 ) , ( break26_g591.y * GlobalTilingY8 )));
				float2 appendResult13_g591 = (float2(( break26_g591.x + GlobalOffsetX10 ) , ( break26_g591.y + GlobalOffsetY9 )));
				float blendOpSrc2_g590 = tex2D( _OcclusionMap, ( ( appendResult14_g591 + appendResult13_g591 ) + Parallaxe380 ) ).r;
				float blendOpDest2_g590 = ( 1.0 - _OcclusionStrength );
				float AmbientOcclusion94 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g590 ) * ( 1.0 - blendOpDest2_g590 ) ) ));
				
				float2 uv_CutoutMask = IN.ase_texcoord8.xy * _CutoutMask_ST.xy + _CutoutMask_ST.zw;
				float4 tex2DNode8_g613 = tex2D( _CutoutMask, uv_CutoutMask );
				#if defined(_CHANNELSELECTED_RED)
				float staticSwitch30_g613 = tex2DNode8_g613.r;
				#elif defined(_CHANNELSELECTED_GREEN)
				float staticSwitch30_g613 = tex2DNode8_g613.g;
				#elif defined(_CHANNELSELECTED_BLUE)
				float staticSwitch30_g613 = tex2DNode8_g613.b;
				#elif defined(_CHANNELSELECTED_ALPHA)
				float staticSwitch30_g613 = tex2DNode8_g613.a;
				#else
				float staticSwitch30_g613 = tex2DNode8_g613.r;
				#endif
				float clampResult24_g613 = clamp( (( _InvertCutout )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g613 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g613 )) )) , 0.0 , 1.0 );
				float temp_output_35_0_g613 = (-0.65 + (_IntensityCutoutMap1 - 0.0) * (0.65 - -0.65) / (1.0 - 0.0));
				float Cutout370 = (( _EnableAlphaClipping )?( ( clampResult24_g613 + temp_output_35_0_g613 ) ):( 1.0 ));
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float2 uv_CutoutMask = IN.ase_texcoord3.xy * _CutoutMask_ST.xy + _CutoutMask_ST.zw;
				float4 tex2DNode8_g613 = tex2D( _CutoutMask, uv_CutoutMask );
				#if defined(_CHANNELSELECTED_RED)
				float staticSwitch30_g613 = tex2DNode8_g613.r;
				#elif defined(_CHANNELSELECTED_GREEN)
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float2 uv_CutoutMask = IN.ase_texcoord4.xy * _CutoutMask_ST.xy + _CutoutMask_ST.zw;
				float4 tex2DNode8_g613 = tex2D( _CutoutMask, uv_CutoutMask );
				#if defined(_CHANNELSELECTED_RED)
				float staticSwitch30_g613 = tex2DNode8_g613.r;
				#elif defined(_CHANNELSELECTED_GREEN)
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g602.a ) ):( tex2DNode7_g602.a ));
				float4 clampResult38_g604 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),(( _SourceMask )?( ( (( _InvertMask )?( ( 1.0 - tex2DNode27_g604 ) ):( tex2DNode27_g604 )) + BaseColorAlpha46 ) ):( (( _InvertMask )?( ( 1.0 - tex2DNode27_g604 ) ):( tex2DNode27_g604 )) ))) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g604 * _IntensityMask ) ):( temp_cast_2 ));
				float3 lerpResult137 = lerp( temp_output_420_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_420_0 , BlendNormal( temp_output_420_0 , NormalDetail155 ) , Mask158.rgb);
				float3 Normal27 = (( _BlendMainNormal )?( lerpResult205 ):( lerpResult137 ));
				
				float2 uv_CutoutMask = IN.ase_texcoord5.xy * _CutoutMask_ST.xy + _CutoutMask_ST.zw;
				float4 tex2DNode8_g613 = tex2D( _CutoutMask, uv_CutoutMask );
				#if defined(_CHANNELSELECTED_RED)
				float staticSwitch30_g613 = tex2DNode8_g613.r;
				#elif defined(_CHANNELSELECTED_GREEN)
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				float2 uv_CutoutMask = IN.ase_texcoord.xy * _CutoutMask_ST.xy + _CutoutMask_ST.zw;
				float4 tex2DNode8_g613 = tex2D( _CutoutMask, uv_CutoutMask );
				#if defined(_CHANNELSELECTED_RED)
				float staticSwitch30_g613 = tex2DNode8_g613.r;
				#elif defined(_CHANNELSELECTED_GREEN)
				...
				surfaceDescription.Alpha = Cutout370;
				surfaceDescription.AlphaClipThreshold = CutOff408;
