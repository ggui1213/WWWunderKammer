Shader "Ciconia Studio/CS_Standard/URP/Standard (Specular setup)/Transparent"
{
	Properties
	{
		...
		[Space(35)][Header(Transparent Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)][Toggle]_InvertTransparent("Invert ", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g679 = uv_BaseMap;
				...
				float4 tex2DNode7_g678 = tex2D( _BaseMap, ( ( appendResult14_g679 + appendResult13_g679 ) + Parallaxe368 ) );
				float4 lerpResult53_g678 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g678 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g678 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g678 = lerpResult53_g678.rgb;
				float desaturateDot29_g678 = dot( desaturateInitialColor29_g678, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g678 = lerp( desaturateInitialColor29_g678, desaturateDot29_g678.xxx, -clampResult27_g678 );
				float4 temp_output_432_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g678 , 0.0 ));
				...
				float2 texCoord387 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 staticSwitch386 = IN.ase_texcoord9.xyz;
				...
				#elif defined(_CHANNELSELECTIONMASK1_GREEN)
				float staticSwitch423 = triplanar393.g;
				#elif defined(_CHANNELSELECTIONMASK1_BLUE)
				float staticSwitch423 = triplanar393.b;
				#elif defined(_CHANNELSELECTIONMASK1_ALPHA)
				float staticSwitch423 = triplanar393.a;
				#else
				float staticSwitch423 = triplanar393.x;
				#endif
				float4 temp_cast_8 = ((( _InvertMask )?( ( 1.0 - (( _EnableTriplanarProjection )?( staticSwitch423 ):( staticSwitch424 )) ) ):( (( _EnableTriplanarProjection )?( staticSwitch423 ):( staticSwitch424 )) ))).xxxx;
				float4 clampResult407 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_8) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float MaskIntensity405 = _IntensityMask;
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult407 * MaskIntensity405 ) ):( temp_cast_6 ));
				float4 lerpResult343 = lerp( temp_output_432_0 , AlbedoDetail153 , Mask158);
				float4 blendOpSrc15_g634 = temp_output_432_0;
				...
				float2 break26_g672 = uv_BumpMap;
				float2 appendResult14_g672 = (float2(( break26_g672.x * GlobalTilingX11 ) , ( break26_g672.y * GlobalTilingY8 )));
				float2 appendResult13_g672 = (float2(( break26_g672.x + GlobalOffsetX10 ) , ( break26_g672.y + GlobalOffsetY9 )));
				float3 unpack4_g671 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g672 + appendResult13_g672 ) + Parallaxe368 ) ), _BumpScale );
				unpack4_g671.z = lerp( 1, unpack4_g671.z, saturate(_BumpScale) );
				float3 tex2DNode4_g671 = unpack4_g671;
				float3 temp_output_433_0 = tex2DNode4_g671;
				...
				float3 lerpResult137 = lerp( temp_output_433_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_433_0 , BlendNormal( temp_output_433_0 , NormalDetail155 ) , Mask158.rgb);
				...
				float2 break26_g676 = uv_EmissionMap;
				float2 appendResult14_g676 = (float2(( break26_g676.x * GlobalTilingX11 ) , ( break26_g676.y * GlobalTilingY8 )));
				float2 appendResult13_g676 = (float2(( break26_g676.x + GlobalOffsetX10 ) , ( break26_g676.y + GlobalOffsetY9 )));
				float4 temp_output_5_0_g675 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g676 + appendResult13_g676 ) + Parallaxe368 ) ) );
				float4 temp_output_435_0 = ( temp_output_5_0_g675 * _EmissionIntensity );
				float4 temp_cast_18 = (0.0).xxxx;
				float4 lerpResult190 = lerp( temp_output_435_0 , temp_cast_18 , Mask158);
				float4 Emission110 = (( _UseEmissionFromMainProperties )?( temp_output_435_0 ):( lerpResult190 ));
				...
				float switchResult36_g662 = (((ase_vface>0)?(_Smoothness):(_SmoothnessBack)));
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g678.a ) ):( tex2DNode7_g678.a ));
				#if defined(_SOURCE_SPECULARALPHA)
				float staticSwitch31_g662 = ( tex2DNode3_g662.a * switchResult36_g662 );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch31_g662 = ( switchResult36_g662 * BaseColorAlpha46 );
				#else
				float staticSwitch31_g662 = ( tex2DNode3_g662.a * switchResult36_g662 );
				#endif
				...
				float2 break26_g674 = uv_OcclusionMap;
				float2 appendResult14_g674 = (float2(( break26_g674.x * GlobalTilingX11 ) , ( break26_g674.y * GlobalTilingY8 )));
				float2 appendResult13_g674 = (float2(( break26_g674.x + GlobalOffsetX10 ) , ( break26_g674.y + GlobalOffsetY9 )));
				float blendOpSrc2_g673 = tex2D( _OcclusionMap, ( ( appendResult14_g674 + appendResult13_g674 ) + Parallaxe368 ) ).r;
				float blendOpDest2_g673 = ( 1.0 - _OcclusionStrength );
				float temp_output_434_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g673 ) * ( 1.0 - blendOpDest2_g673 ) ) ));
				float lerpResult185 = lerp( temp_output_434_0 , 1.0 , Mask158.r);
				float AmbientOcclusion94 = (( _UseAoFromMainProperties )?( temp_output_434_0 ):( lerpResult185 ));
				...
				float2 uv_TransparentMask = IN.ase_texcoord8.xy * _TransparentMask_ST_Instance.xy + _TransparentMask_ST_Instance.zw;
				...
				float staticSwitch30_g642 = tex2DNode8_g642.r;
				#endif
				float4 temp_cast_23 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ))).xxxx;
				float4 clampResult24_g642 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_23) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 _TransparentMask_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardSpecularsetupTransparent,_TransparentMask_ST);
				float2 uv_TransparentMask = IN.ase_texcoord3.xy * _TransparentMask_ST_Instance.xy + _TransparentMask_ST_Instance.zw;
				float4 tex2DNode8_g642 = tex2D( _TransparentMask, uv_TransparentMask );
				#if defined(_CHANNELSELECTION_RED)
				float staticSwitch30_g642 = tex2DNode8_g642.r;
				#elif defined(_CHANNELSELECTION_GREEN)
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 AlbedoDetail153 = CalculateContrast(_DetailBrightness,float4( desaturateVar29_g468 , 0.0 ));
				float4 temp_cast_6 = (0.0).xxxx;
				float2 texCoord387 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode392 = tex2D( _DetailMask, texCoord387 );
				#if defined(_CHANNELSELECTIONMASK1_RED)
				float staticSwitch424 = tex2DNode392.r;
				#elif defined(_CHANNELSELECTIONMASK1_GREEN)
				...
				float4 lerpResult190 = lerp( temp_output_435_0 , temp_cast_16 , Mask158);
				float4 Emission110 = (( _UseEmissionFromMainProperties )?( temp_output_435_0 ):( lerpResult190 ));
				
				float4 _TransparentMask_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardSpecularsetupTransparent,_TransparentMask_ST);
				float2 uv_TransparentMask = IN.ase_texcoord4.xy * _TransparentMask_ST_Instance.xy + _TransparentMask_ST_Instance.zw;
				float4 tex2DNode8_g642 = tex2D( _TransparentMask, uv_TransparentMask );
				#if defined(_CHANNELSELECTION_RED)
				float staticSwitch30_g642 = tex2DNode8_g642.r;
				#elif defined(_CHANNELSELECTION_GREEN)
				...
				#endif
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g678.a ) ):( tex2DNode7_g678.a ));
				float4 temp_cast_18 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ))).xxxx;
				float4 clampResult24_g642 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_18) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 Transparent358 = ( clampResult24_g642 * ( 1.0 - _IntensityTransparentMap ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				#endif
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g678.a ) ):( tex2DNode7_g678.a ));
				float4 temp_cast_16 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ))).xxxx;
				float4 clampResult24_g642 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_16) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 Transparent358 = ( clampResult24_g642 * ( 1.0 - _IntensityTransparentMap ) );
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float _TriplanarFalloff_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardSpecularsetupTransparent,_TriplanarFalloff);
				#if defined(_TRIPLANARSPACEPROJECTION_OBJECTSPACE)
				float3 staticSwitch386 = IN.ase_texcoord7.xyz;
				#elif defined(_TRIPLANARSPACEPROJECTION_WORLDSPACE)
				float3 staticSwitch386 = WorldPosition;
				#else
				float3 staticSwitch386 = IN.ase_texcoord7.xyz;
				...
				float staticSwitch423 = triplanar393.x;
				#endif
				float4 temp_cast_4 = ((( _InvertMask )?( ( 1.0 - (( _EnableTriplanarProjection )?( staticSwitch423 ):( staticSwitch424 )) ) ):( (( _EnableTriplanarProjection )?( staticSwitch423 ):( staticSwitch424 )) ))).xxxx;
				float4 clampResult407 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_4) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float MaskIntensity405 = _IntensityMask;
				...
				float4 _TransparentMask_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardSpecularsetupTransparent,_TransparentMask_ST);
				float2 uv_TransparentMask = IN.ase_texcoord5.xy * _TransparentMask_ST_Instance.xy + _TransparentMask_ST_Instance.zw;
				float4 tex2DNode8_g642 = tex2D( _TransparentMask, uv_TransparentMask );
				#if defined(_CHANNELSELECTION_RED)
				float staticSwitch30_g642 = tex2DNode8_g642.r;
				#elif defined(_CHANNELSELECTION_GREEN)
				...
				float4 tex2DNode7_g678 = tex2D( _BaseMap, ( ( appendResult14_g679 + appendResult13_g679 ) + Parallaxe368 ) );
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g678.a ) ):( tex2DNode7_g678.a ));
				float4 temp_cast_7 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g642 )) ))).xxxx;
				float4 clampResult24_g642 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_7) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 Transparent358 = ( clampResult24_g642 * ( 1.0 - _IntensityTransparentMap ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				float4 _TransparentMask_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardSpecularsetupTransparent,_TransparentMask_ST);
				float2 uv_TransparentMask = IN.ase_texcoord.xy * _TransparentMask_ST_Instance.xy + _TransparentMask_ST_Instance.zw;
				float4 tex2DNode8_g642 = tex2D( _TransparentMask, uv_TransparentMask );
				#if defined(_CHANNELSELECTION_RED)
				float staticSwitch30_g642 = tex2DNode8_g642.r;
				#elif defined(_CHANNELSELECTION_GREEN)
				...
				surfaceDescription.Alpha = Transparent358.r;
